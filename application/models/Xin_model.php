...
class Xin_model extends CI_Model {
	...
	public function select_module_class($mClass,$mMethod) {
		...
		// admin menu
		else if($mMethod=='last_login' && $mClass=='customers') {
			$arr['customers_last_login_active'] = 'active';
			$arr['crm_open'] = 'active';
			return $arr;
		} else if($mClass=='company') {
			$arr['company_active'] = 'active';
			return $arr;
		} else if($mClass=='warehouse') {
			$arr['warehouse_active'] = 'active';
			return $arr;
		} else if($mClass=='customers') {
			$arr['customers_active'] = 'active';
			$arr['crm_open'] = 'active';
			return $arr;
		} else if($mMethod=='import' && $mClass=='users') {
			$arr['users_import_active'] = 'active';
			...
			$arr['system_open'] = 'active';
			return $arr;
		} else if($mMethod=='out_of_stock' && $mClass=='products') {
			$arr['out_of_stock_active'] = 'active';
			$arr['products_open'] = 'active';
			return $arr;
		} else if($mMethod=='expired_stock' && $mClass=='products') {
			$arr['expired_stock_active'] = 'active';
			$arr['products_open'] = 'active';
			return $arr;
		} else if($mMethod=='import' && $mClass=='products') {
			$arr['import_products_active'] = 'active';
			$arr['products_open'] = 'active';
			return $arr;
		} else if($mMethod=='categories' && $mClass=='products') {
			$arr['categories_product_active'] = 'active';
			$arr['products_open'] = 'active';
			return $arr;
		} else if($mMethod=='taxes' && $mClass=='orders') {
			$arr['taxes_active'] = 'active';
			$arr['products_open'] = 'active';
			return $arr;
		} else if($mClass=='products') {
			$arr['products_active'] = 'active';
			$arr['products_open'] = 'active';
			return $arr;
		} else if($mMethod=='last_login' && $mClass=='users') {
			$arr['users_last_login_active'] = 'active';
			$arr['system_open'] = 'active';
			return $arr;
			...
			$arr['system_open'] = 'active';
			return $arr;
		} else if($mClass=='calendar') {
			$arr['calendar_active'] = 'active';
			return $arr;
			...
			$arr['products_open'] = 'active';
			return $arr;
		} else if($mClass=='services') {
			$arr['services_active'] = 'active';
			$arr['products_open'] = 'active';
			return $arr;
		} else if($mClass=='transactions') {
			$arr['hr_account_transactions_active'] = 'active';
			$arr['system_open'] = 'active';
			return $arr;
		} else if($mMethod=='payment_gateway' && $mClass=='settings') {
			...
			$arr['system_open'] = 'active';
			return $arr;
		} else if($mClass=='reports' && $mMethod=='purchases_report') {
			$arr['hr_purchases_report'] = 'active';
			$arr['hr_acc_reports_open'] = 'active';
			return $arr;
		} else if($mClass=='reports' && $mMethod=='all_report') {
			$arr['hr_all_report_report'] = 'active';
			$arr['hr_acc_reports_open'] = 'active';
			return $arr;
		} else if($mClass=='reports' && $mMethod=='sales_report') {
			$arr['hr_invoices_report_sales'] = 'active';
			$arr['hr_acc_reports_open'] = 'active';
			return $arr;
		} else if($mClass=='orders' && $mMethod=='create') {
			$arr['hr_invoices_create'] = 'active';
			$arr['hr_sales_open'] = 'active';
			return $arr;
		} else if($mClass=='orders') {
			$arr['hr_invoices_active'] = 'active';
			$arr['hr_sales_open'] = 'active';
			return $arr;
		} else if($mClass=='quotes' && $mMethod=='create') {
			$arr['hr_quotes_create'] = 'active';
			$arr['hr_sales_open'] = 'active';
			return $arr;
		} else if($mClass=='quotes') {
			$arr['hr_quotes_active'] = 'active';
			$arr['hr_sales_open'] = 'active';
			return $arr;
		} else if($mClass=='suppliers') {
			$arr['suppliers_active'] = 'active';
			return $arr;
		} else if($mClass=='purchase' && $mMethod=='create') {
			$arr['hr_purchase_new'] = 'active';
			$arr['hr_purchase_open'] = 'active';
			return $arr;
		} else if($mClass=='purchase') {
			$arr['hr_purchases'] = 'active';
			$arr['hr_purchase_open'] = 'active';
			return $arr;
		}
	}
	...
	// check client email
	public function check_customer_email($client_email) {
	...
	public function get_items() {
		$query = $this->db->get("xin_catalog_products");
	  	return $query->result();
	}
...
ORDER BY `next_birthday`");
	...
	public function read_invoice_transaction($id) {
		...
		$sql = 'SELECT * FROM xin_finance_transaction WHERE invoice_id = ? and transaction_type = ?';
		$binds = array($id,'income');
		$query = $this->db->query($sql, $binds);
		return $query;
	}

	public function convertAmountToWords($grand_total)
	{
		$num=$grand_total;
		$ones = array( 
			1 => "One", 
