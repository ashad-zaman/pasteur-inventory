                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_challan_number');?>" name="challan_number" id="challan_number" type="text" value="<?php //echo $quotes_order_no;?>">
                    </div>
                  </div>
