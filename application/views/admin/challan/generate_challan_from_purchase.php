  ...
  <div class="col-md-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"> <?php echo $this->lang->line('xin_challan_create');?> </h3>
      </div>
      <div class="box-body" aria-expanded="true" style="">
        <div class="row m-b-1">
          <div class="col-md-12">
            ...
            <?php echo form_open('admin/challan/create_new_challan', $attributes, $hidden);?>
            <div class="bg-white">
              <div class="box-block">
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_challan_number');?>" name="challan_number" id="challan_number" type="text" value="<?php echo $challan_order_no;?>">
                      <input type="hidden" name="purchase_id" id="purchase_id" value="<?=$purchase_id;?>"/>
                      <input type="hidden" name="pId" id="pId" value="<?=$pId;?>"/>
                      <input type="hidden" name="qarray" id="qarray" value="<?=$qarray;?>"/>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="challan_date"><?php echo $this->lang->line('xin_challan_date');?></label>
                      <input class="form-control date" placeholder="<?php echo $this->lang->line('xin_challan_date');?>" readonly="readonly" name="challan_date" type="text" value="">
                    </div>
                  </div>
                  <!-- <div class="col-md-4">
                    <div class="form-group">
                ...
                <!-- <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_challan_title');?>" name="challan_title" type="text" value="Delivery Challan -">
                    </div>
                  </div>
                  </div>
                <hr>
                    ...
                    <div class="form-group">
                      <div class="hrsale-item-values">
                        <div data-repeater-list="items">
                          ...
                          $i=0;
                          foreach($this->Purchase_model->get_purchase_items($purchase_id) as $_item):
                          
                          if(!in_array($_item->item_id,$pid)){
                            continue;
                          }
                          $position=array_search($_item->item_id,$pid);
                          ?>
                            <div class="row item-row">
                              ...
                              <div class="form-group mb-1 col-sm-12 col-md-1">
                                ...
                                <br>
                                <input type="text" class="form-control qty_hrs" name="qty_hrs[]" id="qty_hrs" value="<?php echo $qArray[$position];?>">
                              </div>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <textarea name="challan_note" class="form-control"></textarea>
                        </div>
                      </div>
