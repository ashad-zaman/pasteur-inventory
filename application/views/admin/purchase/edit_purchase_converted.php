                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="quote_id" id="quote_id"  data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select');?>">
                          ...
                          <?php foreach($quotes as $quote) {
                            ...
                            <?php if ($quote->quote_id == $quote_id):$select = "selected"; ?>>
                          <?php endif;?>
                          <option value="<?php echo $quote->quote_id?>"  <?=$select;?>><?php echo $quote->quote_number?></option>
                          <?php } ?>
                        </select>
                      </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_acc_purchase_no'); ?>" name="purchase_number" type="text" >
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
        ...
        ?>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control date" placeholder="<?php echo $this->lang->line('xin_e_details_date'); ?>"  name="purchase_date" type="text" value="<?=$quote_date;?>">
                    </div>
                  </div>
                  <!-- <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <div class="hrsale-item-values">
                        <div data-repeater-list="items">
                          <div data-repeater-item="">
                            <?php $prod = array();foreach ($this->Quotes_model->get_quote_items($quote_id) as $key=>$_item): ?>
                            <div class="row item-row">
                              ...
                              <!-- <div class="form-group mb-1 col-sm-12 col-md-2">
                                ...
                                <select class="form-control tax_type" name="etax_type[]" id="tax_type">
                              ...
                              <div class="form-group mb-1 col-sm-12 col-md-1">
                                ...
                                <br>
                                <input type="text" readonly="readonly" class="form-control" name="etax_rate_item[]" value="<?php echo $_item->item_tax_rate; ?>" />
                              </div> -->
                              ...
                              <div class="form-group mb-1 col-sm-12 col-md-1">
                                ...
                                <br>
                                <input type="text" class="form-control code" name="code[]" id="code" value="<?php echo $_item->code;?>">
                              </div>

                              <div class="form-group mb-1 col-sm-12 col-md-1">
                                <label for="capacity" class="cursor-pointer"><?php echo $this->lang->line('xin_acc_item_capacity');?></label>
                                <br>
                                <input type="text" class="form-control capacity" name="capacity[]" id="capacity" value="<?php echo $_item->capacity;?>">
                              </div>
                              <div class="form-group mb-1 col-sm-12 col-md-2">
                                <label for="remarks" class="cursor-pointer"><?php echo $this->lang->line('xin_acc_remarks');?></label>
                                <br>
                                <input type="text" class="form-control remarks" name="remarks[]" id="remarks" value="<?php echo $_item->remarks;?>">
                              </div>
                              <div class="form-group mb-2 col-sm-12 col-md-1">
                                ...
                                <br>
                                <input type="text" class="form-control" name="qty_hrs[]" id="qty_hrs" value="<?php echo $_item->item_qty;?>" >
                              </div>
                              <div class="skin skin-flat form-group mb-1 col-sm-12 col-md-2">
                                <label for="unit_price"><?php echo $this->lang->line('xin_acc_unit_price'); ?></label>
                                <br>
                                <input class="form-control unit_price" type="text" name="unit_price[]" value="<?php echo $_item->item_unit_price;?>" id="unit_price" />
                              </div>
                              <div class="form-group mb-1 col-sm-12 col-md-2">
                                <label for="profession"><?php echo $this->lang->line('xin_acc_subtotal'); ?></label>
                                <input type="text" class="form-control sub-total-item" readonly="readonly" name="sub_total_item[]" value="<?php echo $_item->item_sub_total; ?>" />
                                <!-- <br>-->
                              ...
                              <div class="form-group col-sm-12 col-md-1 text-xs-center mt-2">
                                ...
                                <br>
                                <button type="button" class="btn icon-btn btn-xs btn-danger waves-effect waves-light eremove-item" data-repeater-delete="" data-record-id="<?php echo $key;?>" data-invoice-id="<?php echo $quote_id;?>"> <span class="fa fa-trash"></span></button>
                              </div>
                            </div>
                            <?php endforeach;?>
                          </div>
...
?>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <textarea name="purchase_note" class="form-control"><?php echo $quote_note; ?></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
