...
<div class="row item-row">
  ...
  <div class="form-group mb-1 col-sm-12 col-md-1">
    <label for="capcity" class="cursor-pointer"><?php echo $this->lang->line('xin_acc_item_capacity');?></label>
    <br>
  ...
  <div class="form-group mb-1 col-sm-12 col-md-2">
    ...
    <input type="text" class="form-control sub-total-item" readonly="readonly" name="sub_total_item[]" style="text-align: right;"   value="0"  />
