  ...
  <div class="col-md-12">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"> <?php echo $this->lang->line('xin_acc_create_order_invoice');?> </h3>
      </div>
      <div class="box-body" aria-expanded="true" style="">
        <div class="row m-b-1">
          <div class="col-md-12">
            ...
            <?php echo form_open('admin/orders/create_new_invoice', $attributes, $hidden);?>
            <div class="bg-white">
              <div class="box-block">
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_acc_order_invoice_no');?>" name="invoice_number" type="text" value="<?php //echo $invoice_order_no;?>">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
