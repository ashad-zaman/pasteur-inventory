...
<div class="row">
  <div class="col-xs-12"> &nbsp; <small class="pull-right">
    <div class="btn-group pull-right" role="group" style="margin-top:2px;margin-right: 30px;">
      <div class="btn-group">
...
<div class="invoice  <?php echo $get_animate;?>" style="margin-top:40px;">
  <div id="">
    ...
    <div class="row">
      ...
      <div class="row">
        <div class="col-sm-4 ">
        <span class="logo-lg">
          <img alt="<?php echo $system[0]->application_name;?>" src="<?php echo base_url();?>uploads/logo/<?php echo $company_info[0]->logo;?>" class="brand-logo"> </span>
        </div>
    ...
    <!-- info row -->
      ...
      <div class="row invoice-info">
        ...
        ?>
        <div class="col-sm-8 invoice-col" style="font-size:11px;"> <?php echo $this->lang->line('xin_acc_to');?>
          <address>
        ...
        <div class="col-sm-4 invoice-col" style="float:right;"> 
          <table style="float:right;width: 100%;" width="100%">
            <tr><td style="text-align: right;font-size:11px;"><b><?php echo $this->lang->line('xin_createdp');?>:</b></td><td style="text-align: right;white-space:nowrap; padding-left:10px;font-size:11px;"><?php echo $this->Xin_model->set_date_format($quote_date);?></td></tr>
            <tr><td style="text-align: right;font-size:11px;"><b><?php echo $this->lang->line('xin_quote_our_ref');?>: </b></td><td style="text-align: right;white-space:nowrap;padding-left:10px;font-size:11px;" ><?php echo $quote_number;?></td></tr>
            <tr><td style="text-align: right;font-size:11px;"><b><?php echo $this->lang->line('xin_quote_your_ref');?>: </b></td><td style="text-align: right;white-space:nowrap;padding-left:10px;font-size:11px;"><?php echo $your_ref;?></td></tr>
            <tr><td style="text-align: right;font-size:11px;"><b><?php echo $this->lang->line('xin_quote_Revision');?>: </b></td><td style="text-align: right;white-space:nowrap;padding-left:10px;font-size:11px;"><?php echo $revision;?></td></tr>
            <tr><td style="text-align: right;white-space:nowrap;font-size:11px;" ><b><?php echo $this->lang->line('xin_quote_Demand_order_no');?>: </b></td><td style="text-align: right;white-space:nowrap;padding-left:10px;font-size:11px;"><?php echo $demand_order_no;?></td></tr>
          </table>
        </div>
        <!-- /.col --> 
      </div>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 table-responsive">
           <p style="text-align:center;text-decoration:underline;font-size:12px;"><strong style="font-size:15px;"> <?php echo $quote_title;?></strong></p>
        </div>
      </div>
      <!-- Table row -->
      <div class="row">
          ...
          <table class="table productlist">
            ...
            <tbody>
              <?php
				...
				$sc_show = $ar_sc[1];
				?>
              <?php $prod = array(); $i=1; $j=0; foreach($this->Quotes_model->get_quote_items($quote_id) as $_item):?>
      ...
      <div class="row"> 
        ...
        <div class="col-xs-12 col-sm-12 table-responsive" style="text-align:left">
                  <table class="table  termscondition" style="float:left">
                    ...
                    <tr><td  width="30%" style="font-size:12px;"><b><?php echo $this->lang->line('xin_quote_terms_of_payment');?>:</b></td><td style="font-size:12px;"><?php echo $terms_of_payment;?></td></tr>
                    <tr><td style="font-size:12px;"><b><?php echo $this->lang->line('xin_quote_delivery_codition');?>:</b></td><td style="font-size:12px;"><?php echo $delivery_condition;?></td></tr>
                    <tr><td style="font-size:12px;"><b><?php echo $this->lang->line('xin_quote_offer_validity');?>:</b></td><td style="font-size:12px;"><?php echo $offer_validity;?></td></tr>
                    <tr><td style="font-size:12px;"><b><?php echo $this->lang->line('xin_quote_delivery_time');?>:</b></td><td style="font-size:12px;"><?php echo $delivery_time;?></td></tr>
                    <tr><td style="font-size:12px;"><b><?php echo $this->lang->line('xin_quote_partial_shipment');?>:</b></td style="font-size:12px;"><td><?php echo $partial_shipment;?></td></tr>
                  </table>
        </div>
      </div>
...
function convertAmountToWords($grand_total)
{
  $num=$grand_total;
  $ones = array( 
    1 => "One", 
