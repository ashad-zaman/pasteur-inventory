                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_quote_number');?>" name="quote_number" id="quote_number" type="text" value="<?php echo $quote_number;?>">
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control " placeholder="<?php echo $this->lang->line('xin_quote_your_ref');?>" name="your_ref" type="text" value="<?php echo $your_ref;?>">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="revision"><?php echo $this->lang->line('xin_quote_Revision');?></label>
                      <input class="form-control " placeholder="<?php echo $this->lang->line('xin_quote_Revision');?>"  name="revision" type="text" value="<?php echo $revision;?>">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="demand_order_no"><?php echo $this->lang->line('xin_quote_Demand_order_no');?></label>
                      <input class="form-control " placeholder="<?php echo $this->lang->line('xin_quote_Demand_order_no');?>"  name="demand_order_no" type="text" value="<?php echo $demand_order_no;?>">
                    </div>
                  </div>
                  </div>
                  </div>
                  ...
                  <div class="col-md-10">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="<?php echo $this->lang->line('xin_quote_title');?>" name="quote_title" type="text" value="<?php echo $quote_title;?>">
                    </div>
                  </div>
                  </div>
                          ...
                          <div data-repeater-item="">
                            ...
                            <div class="row item-row">
                              ...
                              <div class="form-group mb-1 col-sm-12 col-md-1">
                                ...
                                <br>
                                <input type="text" class="form-control code" name="ecode[<?php echo $_item->quote_item_id;?>]" id="code" value="<?php echo $_item->code;?>">
                              </div>

                              <div class="form-group mb-1 col-sm-12 col-md-1">
                                <label for="capacity" class="cursor-pointer"><?php echo $this->lang->line('xin_acc_item_capacity');?></label>
                                <br>
                                <input type="text" class="form-control capacity" name="ecapacity[<?php echo $_item->quote_item_id;?>]" id="capacity" value="<?php echo $_item->capacity;?>">
                              </div>
                              <div class="form-group mb-1 col-sm-12 col-md-2">
                                <label for="remarks" class="cursor-pointer"><?php echo $this->lang->line('xin_acc_remarks');?></label>
                                <br>
                                <input type="text" class="form-control remarks" name="eremarks[<?php echo $_item->quote_item_id;?>]" id="remarks" value="<?php echo $_item->remarks;?>">
                              </div>
                              ...
                              <div class="skin skin-flat form-group mb-1 col-sm-12 col-md-2">
                                ...
                                <br>
                                <input class="form-control unit_price" type="text" name="eunit_price[<?php echo $_item->quote_item_id;?>]" style="text-align: right;" value="<?php echo $_item->item_unit_price;?>" id="unit_price" />
                              </div>
                              <div class="form-group mb-1 col-sm-12 col-md-2">
                                <label for="profession"><?php echo $this->lang->line('xin_acc_subtotal');?></label>
                                <input type="text" class="form-control sub-total-item" readonly="readonly" name="esub_total_item[<?php echo $_item->quote_item_id;?>]" style="text-align: right;" value="<?php echo $_item->item_sub_total;?>" />
                                <!-- <br>-->
