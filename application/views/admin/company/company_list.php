          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input class="form-control" placeholder="<?php echo $this->lang->line('xin_company_short_name');?>" name="short_name" type="text">
              </div>
              <div class="form-group">
                <div class="row">
                  <div class="col-md-6">
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input class="form-control" placeholder="<?php echo $this->lang->line('xin_company_code');?>" name="code" type="text">
                  </div>
      ...
      <table class="datatables-demo table table-striped table-bordered" id="xin_table">
        <thead>
          <tr>
            ...
            <th><?php echo $this->lang->line('module_company_code');?></th>
