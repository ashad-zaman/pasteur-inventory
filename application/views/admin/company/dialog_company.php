    ...
    <div class="row">
      <div class="col-sm-6">
        ...
        <div class="form-group">
          ...
          <input class="form-control" placeholder="<?php echo $this->lang->line('xin_company_short_name');?>" name="short_name" type="text" value="<?php echo $short_name;?>">
        </div>
        <div class="form-group">
          <div class="row">
            <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <input class="form-control" placeholder="<?php echo $this->lang->line('xin_company_code');?>" name="code" type="text" value="<?php echo $code;?>" >
              </div>
  ...
  <div class="modal-body">
    ...
    <table class="footable-details table table-striped table-hover toggle-circle">
      <tbody>
        ...
        <tr>
          <th><?php echo $this->lang->line('xin_company_code');?></th>
